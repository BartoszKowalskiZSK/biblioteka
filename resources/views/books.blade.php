            ...
            <div class="text-center">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                    ...
                    <div class="bg-slate-700 h-64 w-full p-4 rounded-lg shadow-md relative">
                        ...
                        @endif
                        <h3 class="font-bold text-lg text-gray-900 dark:text-gray-100 mt-2">{{ $book['name'] }}</h3>
                        <form action="{{ route('cart.add', ['productId' => $book['id']]) }}" method="GET">
                            @csrf
                            <div class="flex justify-center mt-4 align-items-end">
                                <button type="submit" class="inline-block bg-orange-500 hover:bg-orange-700 text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline">Dodaj do koszyka</button>
                            </div>
                        </form>
                    </div>
                    @endforeach
